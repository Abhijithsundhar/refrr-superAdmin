...
import 'add-aafiliate.dart';
import 'edit-affiliate.dart';

class AffiliateTable extends ConsumerStatefulWidget {
  @override
  _AffiliateTableState createState() => _AffiliateTableState();
}

class _AffiliateTableState extends ConsumerState<AffiliateTable> {
  int currentPage = 0;
              ...
              onTap: () {
                Future.delayed(Duration(milliseconds : 50),(){
                  showDialog(
                    ...
                    builder: (_) =>  AddAffiliateAlertBox(),
                  );
                });
              },
              child: CircleAvatar(
                        ...
                        return Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              buildListCell(data.level, width),
                                  ...
                                  onTap:() {
                                    Future.delayed(Duration(milliseconds : 50),(){
                                      showDialog(
                                        context: context,
                                        // barrierDismissible: false,
                                        builder: (_) =>  EditAffiliateAlertBox(affiliate: data ),
                                      );
                                    });
                                  },
                                  child: Center(
