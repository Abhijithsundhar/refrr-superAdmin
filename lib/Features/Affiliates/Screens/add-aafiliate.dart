...
import '../Controllors/industry-controllor.dart';

class AddAffiliateAlertBox extends StatefulWidget {
  const AddAffiliateAlertBox({super.key});

  @override
  State<AddAffiliateAlertBox> createState() => _AddAffiliateAlertBoxState();
}

class _AddAffiliateAlertBoxState extends State<AddAffiliateAlertBox> {
  ...
  void initState() {
    super.initState();
    affiliateStatusController.text = '';
    affiliateLevelController.text = '';
    affiliateEmailController.text = '';
    affiliatePasswordController.text = '';
    affiliateUserIdController.text = '';
    affiliateZoneController.text = '';
    affiliatePhoneNoController.text = '';
    affiliateNameController.text = '';
    affiliateCountryController.text = '';
    affiliateLanguageController.text = '';
    pickedProfile = null;
  }
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: labelWithField(
                                    'Language',
                                    controller: affiliateLanguageController,
                                    options: [
                            ...
                            Row(
                              children: [
                                Expanded(
                                  child: labelWithField(
                                    'Country',
                                    controller: affiliateCountryController,
                                ...
                                Expanded(
                                  child: labelWithField(
                                    'Zone',
                                    controller: affiliateZoneController,
                                    options: [
                            ...
                            Row(
                              children: [
                                Expanded(child: labelWithField('Qualification', controller: affiliateQualificationController,
                                  options: [
                                    'SSLC',
                                    'Higher Secondary',
                                    'Diploma',
                                ...
                                SizedBox(width: width * .01),
                                Expanded(child: labelWithField('Experience', controller: affiliateExperienceController,
                                    options: [
                                      'Less than 1 year',
                                      '1 year',
                                      '2 years',
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: labelWithField(
                                    'Level',
                                    controller: affiliateLevelController,
                            ...
                            labelWithField('More Info', controller: affiliateMoreInfoController, maxLines: 4,
                            ),
                                      ...
                                      showCustomAlertBox(
                                        ...
                                        'Do you want add this Affiliate?',
                                          ...
                                          try {
                                            ...
                                            final AffiliateModel affiliate = AffiliateModel(
                                                ...
                                                search: setSearchParam(
                                                  affiliateNameController.text.trim().toUpperCase() +
                                                      ...
                                                      ' ' +
                                                      affiliateQualificationController.text.trim().toUpperCase() +
                                                      ' ' +
                                                      affiliateExperienceController.text.trim().toUpperCase() +
                                                      ' ' +
                                                ...
                                                qualification: affiliateQualificationController.text,
                                                experience: affiliateExperienceController.text,
                                                moreInfo: affiliateMoreInfoController.text,
                                                industry: selectedIndustries,
                                                leadScore: 0) ;

                                            print('Calling addAdmin...');
                                            await ref.read(affiliateControllerProvider.notifier)
                                                .addAffiliate(context: context, affiliateModel: affiliate);
                                            ...
                                            affiliateLanguageController.clear();
                                            affiliateQualificationController.clear();
                                            affiliateExperienceController.clear();
                                            affiliateIndustryController.clear();
                                            affiliateMoreInfoController.clear();
