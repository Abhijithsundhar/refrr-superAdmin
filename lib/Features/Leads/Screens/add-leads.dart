...
class AddLeadsAlertBox extends StatefulWidget {
  const AddLeadsAlertBox({super.key});

  @override
  State<AddLeadsAlertBox> createState() => _AddLeadsAlertBoxState();
}

class _AddLeadsAlertBoxState extends State<AddLeadsAlertBox> {
  ...
  void initState() {
    super.initState();
    leadsFirmNameController.text = '';
    leadsIndustryController.text = '';
    leadsContactNoController.text = '';
    leadsEmailController.text = '';
    leadsCountryController.text = '';
    leadsZoneController.text = '';
    leadsWebsiteController.text = '';
    leadsAddressController.text = '';
    leadsCurrencyController.text = '';
    leadsAboutFirmController.text = '';
    leadsAffiliateController.text = '';
    pickedProfile = null;
  }
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: InkWell(
                            ...
                            child: pickedProfile != null
                              ...
                              child: Image.asset('assets/images/icanyonlogo.png',fit: BoxFit.fill),
                            ),
                          ),
                        ),
                        // SizedBox(
                        //   width: width * .1,
                        //   child:
                        //   Image.asset('assets/images/icanyonlogo.png'),
                        // ),
                      ],
                    ),
                  ),
                            ...
                            Row(
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: Column(
                                    children: [
                                      labelWithField('Currency type',controller: leadsCurrencyController),
                                        ...
                                        'Do you want add this Lead?',
                                          ...
                                          try {
                                            ...
                                            await ref.read(leadsControllerProvider.notifier)
                                                .addLeads(context: context, leadsModel: leads);
                                            print('addAdmin completed');

                                            hideLoading(context);

                                             leadsFirmNameController.clear();
                                             leadsIndustryController.clear();
                                             leadsContactNoController.clear();
                                             leadsEmailController.clear();
                                             leadsCountryController.clear();
                                             leadsZoneController.clear();
                                             leadsWebsiteController.clear();
                                             leadsAddressController.clear();
                                             leadsCurrencyController.clear();
                                             leadsAboutFirmController.clear();
                                             leadsAffiliateController.clear();
                                            setState(() {
                                              pickedProfile = null;
                                            });
